    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-800 py-6 px-6">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('owner.employee-accounts.create') }}" 
                   class="px-4 py-2 bg-white text-blue-700 rounded-md hover:bg-blue-50 transition duration-200 flex items-center gap-2 font-medium shadow-sm">
        ...
        @if($employees->isEmpty())
            <div class="text-center py-16 px-6">
                ...
                <div class="mt-6">
                    <a href="{{ route('owner.employee-accounts.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-3">
                                        <a href="{{ route('owner.employee-accounts.edit', $employee->id) }}" 
                                           class="text-indigo-600 hover:text-indigo-900 transition-colors duration-200 flex items-center gap-1">
