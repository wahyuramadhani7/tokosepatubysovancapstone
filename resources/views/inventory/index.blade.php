        ...
        <div style="background-color: #292929;" class="flex flex-col md:flex-row justify-between items-center p-4 md:p-6 mb-6 rounded-lg gap-4 shadow-sm">
            <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('inventory.history') }}" class="bg-blue-500 text-white font-medium text-sm md:text-base rounded-lg px-4 py-2.5 hover:bg-blue-600 transition-colors flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
